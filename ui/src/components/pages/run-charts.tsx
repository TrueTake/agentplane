      ...
      <ResponsiveContainer width="100%" height={220}>
        <LineChart data={data} margin={{ top: 4, right: 16, left: 0, bottom: 0 }}>
          ...
          <YAxis
            ...
            tickLine={false}
            axisLine={false}
            {...(yLabel ? { label: { value: yLabel, angle: -90, position: "insideLeft" as const, fontSize: 11 } } : {})}
          ...
          <Tooltip
            ...
            formatter={(value: unknown, name: unknown) => [valueFormatter(Number(value)), String(name)]}
          />
