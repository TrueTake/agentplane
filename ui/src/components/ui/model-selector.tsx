...
function formatPrice(perMillion: number | null | undefined): string {
...
export function ModelSelector({ value, onChange, disabled }: ModelSelectorProps) {
  ...
  useEffect(() => {
    ...
    (client.models.list() as Promise<CatalogModel[]>)
                ...
                >
                  {providerModels.map((m) => (
                    ...
                    >
                      ...
                      <span className="text-right text-xs text-muted-foreground">
                        {formatPrice(m.input_price_per_million)}
                      </span>
                      <span className="text-right text-xs text-muted-foreground">
                        {formatPrice(m.output_price_per_million)}
                      </span>
